    ...
    <section className="w-full flex justify-center mt-32">
      <div className="w-full max-w-[1200px]">
        ...
        <div className="max-w-[466px]">
          ...
          <p className="text-[#FF6243] font-semibold text-[15.75px]">
            Account management
          </p>

          <h2 className="text-[46.5px] leading-[56px] tracking-[-1.2px] font-semibold mt-4">
            World class account
            <br />
            management
          </h2>

          <p className="text-[17.58px] leading-[32px] text-gray-500 mt-6">
