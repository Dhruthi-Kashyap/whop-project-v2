export default function StockDadsCard() {
  return (
      ...
      <div className="w-[1216px] h-[394px] flex justify-between items-center">
        ...
        <div className="w-[452px] h-[373px] flex flex-col">
          ...
          <p className="mt-6 text-[17.44px] leading-[32px] text-[#D1D5DB]">
            StockDads is a trading community that provides accessible education,
            resources, and support that can positively impact the financial
